(// Advanced Cricket Synth Definition
SynthDef(\advancedCricket, {
    ...
    sig = sig * EnvGen.kr(Env.linen(0.01, 0.98, 0.01), doneAction: 2);
...
// Pattern to play the advanced cricket synth
(Pdef(\cricketPattern,
    Pbind(
        ...
        \chirpSpeed, Pwhite(10, 30, inf),  // Random chirp speed
