...
~next = {|d|
  ...
  var decay = (d.sensors.gyroEvent.y/pi).lincurve(-0.5,0.5,0.2,0.2,-2);
  var sustain = (d.sensors.gyroEvent.y/pi).lincurve(-0.5,0.5,0.02,0.8,-2);
  var release = (d.sensors.gyroEvent.y/pi).lincurve(-0.5,0.5,0.1,1.9,-2);
