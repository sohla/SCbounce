...
SynthDef(\pullstretchMonoQ, {|out, amp = 1, buffer = 0, envbuf = -1, pch = 1, div=1, speed = 0.08, splay = 0.3,pan=0, gate=1, delta=0, lag=0.05, ffo=10 rfo=1,pos=0|
  ...
  var afo = LFCub.ar(ffo,0,rfo).range(1.0 - rfo,2.0 - rfo);
	var sp = Splay.arFill(8,
		{ |i| Warp1.ar(1, buffer, lfo.linlin(0,1,0.4,0.7), pch * (1 / ((i*delta)+1)) * [1] ,splay, envbuf, 8, 0.1 * (i+1), 4)  },
