...
rhythm:      16-slot grid = TWO score bars (a bar is 8 events: ~scoreBeatsPerBar 2 × ~scoreEventsPerBeat 4). Pattern picked by tier; layer picked by section. Fill frequency modulated by engagement (arc).
