...
pitch:       ~scoreVoicePool wrapped to pitch class, indexed by Pslide's \slideIdx. Root = 0 (note carries absolute PC). \octave state-driven (idle 4–6, tuning 5, piece 4–6 from tilt, curtain 3–4). \ptch = sample rate multiplier for continuous bend (tuning ramps 0.7 → 1.0 over 20 s). Sparse sample set covered by findClosestSample.
